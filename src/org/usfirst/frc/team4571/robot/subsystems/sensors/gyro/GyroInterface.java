 ...
 * 
 * @author Team254 : https://github.com/Team254/FRC-2015/blob/bb03fa5146c8611eead83fe8056ac74a20e1f651/src/com/team254/lib/util/gyro/
 */
public class GyroInterface {
        ...
        if (result != 1) {
            System.out.println(
                    "Unexpected self-check response: 0x" + Integer.toHexString(result) +
                            " errors: " + extractErrors(result).stream().map(ErrorFlag::name).collect(Collectors.joining( ", ")));
        }
    ...
    public class GyroException extends Exception {
		...
		private static final long serialVersionUID = -5124385142867859569L;
